...
const dummyOtherComments: OtherComment[] = [
  {
    ...
    choice: "agree",
    comment:
      "ちょっとお金かかっても、安心して子どもを連れて行ける場所ならアリだと思う！",
  },
  {
    id: 2,
    choice: "agree",
    comment:
      "無料だと人が多すぎて落ち着かないし…有料のほうがゆったり使えそう😊",
  },
  {
    id: 3,
    choice: "disagree",
    comment:
      "子育てってお金かかるから…交流スペースくらいは無料で気軽に行ける場所にしてほしい！",
  },
  {
    id: 4,
    choice: "agree",
    comment: "お金払った分、サービスもちゃんとしてるなら納得かな！",
  },
  {
    id: 5,
    choice: "agree",
    comment:
      "ちょっと有料でも、子どもの遊び場がキレイで安全なら安心して通える✨",
  },
  {
    id: 6,
    choice: "disagree",
    comment: "せっかく交流の場なのに、お金の心配があると行きづらいと思うなあ",
  },
];
